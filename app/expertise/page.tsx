...
const timeline = [
  ...
  },
  {
    ...
    body: [
      "Craig joined Definitive Audio in 1993 as a salesperson in the Seattle showroom. Later that same year, he was asked to take on the responsibility of managing the company's new Bellevue showroom — an opportunity that quickly revealed both his leadership ability and his talent for building lasting client relationships.",
      "Through years of successful projects, industry innovation, and an unwavering commitment to performance system design, Craig rose through the organization to become a partner and ultimately President of the company.",
      "Over the next 25 years, Craig helped shape Definitive Audio into the Pacific Northwest's most respected high-performance audio and custom installation firm. While firmly rooted in the region, the company earned a national reputation as a leader in performance audio and video, recognized across the United States for its expertise and excellence.",
      "Under his leadership, the company delivered some of the region's most ambitious residential and commercial systems — including reference-level music rooms, private cinemas, and unique commercial A/V systems designed to rival the experience of the world's finest venues.",
      "In 2018, after a quarter century of growth, leadership, and influence within the industry, the company was successfully sold — marking the close of a defining chapter in Craig's career and the beginning of a new phase focused once again on the craft he loves most.",
    ],
  },
  {
    era: "2018–Present",
    ...
    body: [
      "Since the sale of the company in 2018, Craig has continued with Definitive Audio as Custom Sales Manager, returning to his true passion: creating reference-level music and movie experiences.",
      "Today, there's never been a more thrilling time for multi-channel audio and video. Streaming platforms deliver vast libraries of Dolby Atmos content, letting listeners feel every recording and soundtrack exactly as its creators intended — fully immersive, three-dimensional sound. At the same time, state-of-the-art projection systems and massive flat-panel displays bring images to life with astonishing realism.",
      "Lighting has also become an increasingly important part of the design process. The industry-wide transition from incandescent to LED technology — driven largely by energy efficiency — has created both new opportunities and new challenges in residential environments. Craig's commitment to performance extends beyond audio and video to include lighting and lighting control, helping create spaces that feel natural, visually comfortable, and effortless to manage.",
      "Craig's role today is best described as system performance specialist — seamlessly integrating audio, video, lighting, and control to craft environments that are immersive, intuitive, and truly unforgettable.",
    ],
  },
];
